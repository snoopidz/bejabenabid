...
// this function creates a three-column table and adds it to the screen
   var numDisplayed = 0;
   var tocTable = '';
   var tocHead1 = 'Title of Post';
   var tocTool1 = 'Click to sort by title';
   var tocHead2 = 'History';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note"> Number Of Post ' + postTitle.length + ' Post <br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">Number Of Post  ' + numDisplayed + 'Label\'';
      tocNote += postFilter + '\' *** '+ postTitle.length + 'The Total Number Of Post<br/></span>';
   }
